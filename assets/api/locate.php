<?php
	...
	****************************************************************** */
	...
	while ($RowData = mysqli_fetch_assoc($Rst_Select)) {
		...
		$ShopData["open_time"] = $RowData["open_time"];
		$ShopData["close_time"] = $RowData["close_time"];
		$ShopData["shop_image"] = "http://cloone.my/demo/starglory-admin/assets/upload_files/promotion/". $RowData["attachment"];
	...
	$MainData["LOCATION_MAP"] = "https://www.google.com/maps/embed?origin=mfe&pb=!1m3!2m1!1sStar+Glory+Duty+Free+Shop!6i100";
