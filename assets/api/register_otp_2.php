<?php
	...
	****************************************************************** */
	...
	$fp = fopen('logs/register_otp_2.txt', 'a');
	...
	****************************************************************** */
	...
	$DWUserContact = 60196953091 ;  //ReturnValidContact($_REQUEST["contactno"])
	$DWOTPNumber = 1111; //rand(1000, 9999)

	SendSMS($DWUserContact, $DWOTPNumber);

	echo "This one is at API";
	die();
