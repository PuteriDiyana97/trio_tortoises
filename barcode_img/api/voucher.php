<?php
	...
	****************************************************************** */
	...
	$Sql_Select = "SELECT v.* FROM data_voucher v WHERE v.active = 1 AND v.exchange_point > 0 AND v.voucher_type = 0 ORDER BY v.created DESC";
	...
	if(mysqli_num_rows($Rst_Select) > 0)
		...
		$data['voucher_img_before'] = "http://cloone.my/demo/starglory-admin/assets/upload_files/voucher/". $row["voucher_img_before"];
	...
	if(mysqli_num_rows($Rst_SelectVoucher) > 0){
		...
		$dataVoucher['voucher_img_before'] = "http://cloone.my/demo/starglory-admin/assets/upload_files/voucher/". $row["voucher_img_before"];
		$dataVoucher['voucher_img_after'] = "http://cloone.my/demo/starglory-admin/assets/upload_files/voucher/". $row["voucher_img_after"];
		...
		$dataVoucher['barcode'] = "http://cloone.my/demo/starglory-admin/voucher_barcode/". $row["barcode"];
