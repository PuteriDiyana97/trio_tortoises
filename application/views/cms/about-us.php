	...
	<form class="kt-form" id="form_filter" name="form_filter" action="" method="post" enctype="multipart/form-data">
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__foot text-right">
		        ...
		        <a href="<?=site_url('about-us/details')?>" class="btn btn-success mr-2">Edit</a>
		    </div>
		</div>
	    ...
	    $.ajax({
	        ...
	        success : function(data)
	        {
	        	...
	        	if ( data.length != '0' )
	        	{
					...
					$('#banner_show').append('<img width="180px" height="100px" src="<?=site_url()?>assets/upload_files/abouts/' + data.attachment + '" />');
