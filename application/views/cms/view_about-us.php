  ...
  <form class="kt-form" id="form" name="form" method="post" enctype="multipart/form-data">
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-grid">
                <div class="kt-grid__item kt-grid__item--middle">
                    <div class="form-group row">
                      <div class="col-md-12">
                        <label>Title</label>
                        <input type="text" class="form-control form-control-sm capitalize" name="title" placeholder="Title" value="<?= $info->title ?>">
                      </div>
                      <div class="col-md-12">
                        <label>Description</label>
                        <textarea class="form-control form-control-sm" id="description" name="description"><?= $info->description ?></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-4">
                        ...
                        <?php else: ?>
                       <img src="<?php echo base_url('assets/upload_files/abouts/'. $info->attachment);?>" width="100%"/>
                        <?php endif;?>
                      </div>
                      <div class="col-lg-4">
                        <label>New Banner</label>
                        <input type="file" class="form-control form-control-sm" name="banner" placeholder="Banner">
      ...
      <div class="kt-portlet__foot text-right">
        ...
        <a href="<?=site_url('about-us')?>" class="btn btn-brand btn-bold btn-font-sm btn-sm" id="btn_cancel" name="btn_cancel">Cancel</a>
...
{//$('.summernote').summernote('module', 'videoDialog').createVideoNode = function(url) { *build html* return *html*; };
    ...
    $.ajax({
        data: form_data,
        type: "POST",
        url: '<?php echo site_url('cms/About_Controller/summernote_sync_image')?>',
        cache: false,
        contentType: false,
        processData: false,
                     ...
                     //  console.log('get-participant-save suceess but fail',data);
                      // alert('Action Participant fail.');
                       ...
                       swal.fire({
                          ...
                          $('#form').modal('hide');
                          location.href = "<?=site_url('about-us/details')?>";
                           loading_off();
                      });
