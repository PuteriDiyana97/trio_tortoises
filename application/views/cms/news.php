	    ...
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="modal_title">News</h5>
	    ...
	    $.ajax({
	        ...
	        success : function(data)
	        {
	        	...
	        	if ( data.length != '0' )
	        	{
				    ...
				    {
				      $('#banner_show').append('<img width="100px" height="100px" src="<?=site_url()?>assets/upload_files/news/' + data.attachment + '" />');
				    }
