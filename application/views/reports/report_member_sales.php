		...
		<div class="kt-portlet kt-portlet--mobile">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">Master Sales</h3>
				</div>
			</div>
	            		...
	            		<div class="kt-grid__item kt-grid__item--middle">
		                    <div class="row">
				                        ...
				                        <div class="col-md-2">
											...
											<input type="text" class="form-control form-control-sm" id="filter_nationality" name="filter_nationality" placeholder="Nationality" value="">
				                        </div>
