		...
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__body">
				...
				<div class="kt-portlet__head-actions">
					...
					<i class="fa fa-download"></i> Master Point
					</a>
				</div><br>
				<!--begin: Datatable -->
				<table class="table table-striped- table-bordered table-hover table-checkable data_table_server" id="data_table_server">
					<thead>
						<tr>
							...
							<th class="text-center">Balance Point</th>   <!-- current point -->
							<th class="text-center">Life Time Point</th> <!-- collected point along as member -->
							<th class="text-center">Points Claimed</th>
							<th class="text-center">Balanced Voucher(RM)</th>
							<th class="text-center">Redeemed Voucher(RM)</th>
						</tr>
					</thead>
				</table>
...
var data_table_server = $('.data_table_server').DataTable({ 
	    ...
	    "ajax": {
	        "url": "<?=site_url('report/master-point-list')?>",
	        "type": "POST",
	        data: function (d) {
