...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
	<form class="kt-form" id="form" name="form" method="post" enctype="multipart/form-data">
			...
			<div class="kt-portlet__body">
				...
				<div class="kt-grid">
            		<div class="kt-grid__item kt-grid__item--middle">
	                    <div class="row">
			            	<div class="col-md-9">
								<strong>Number of Category Arrangement <?=COMPULSORY;?></strong>
								<input type="number" class="form-control" id="priority_no" name="priority_no" placeholder="example: 1" required="">
							</div>
						</div><br>
						<div class="row">
							<div class="col-md-9">
								<strong>Category <?=COMPULSORY;?></strong>
								<textarea type="text" class="form-control" id="category" name="category" placeholder="Category" required=""></textarea>
							</div>
						</div>
		        </div>
			</div>
		...
		<div class="kt-portlet__foot text-right">
	                ...
	                <a href="<?=site_url('promotion-category')?>" class="btn btn-brand btn-bold btn-font-sm btn-sm" id="btn_cancel" name="btn_cancel">Cancel
					</a>
...
$(function(){
    ...
    $('#form').on('submit', function(e) {
	    ...
	    if (error_no > 0) {
	        ...
	        $.ajax({
	            type: "POST",
	            url: "<?=site_url('promotion-category/insert')?>",
	            data: dataString,
	            dataType: 'json',
