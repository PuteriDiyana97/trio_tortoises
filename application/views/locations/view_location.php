                ...
                <div class="kt-grid__item kt-grid__item--middle">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control capitalize" name="store_name" id="store_name" placeholder="Location Name" value="<?= $location_info->store_name ?>">
                            </div>
                            <div class="col-md-8">
                                        <strong for="contact_no">Phone Number</strong>
                                        <input type="text" class="form-control" name="contact_no" id="contact_no" placeholder="Phone Number" value="<?= $location_info->contact_no ?>">
                            </div>
                        </div><br>
                        <div class="row">
                                    <div class="col-md-2"> 
                                          <strong for="open_hours">Open Time</strong>
                                          <input class="form-control" id="kt_timepicker_1" name="open_time" readonly="" placeholder="Select time" type="text" value="<?= $location_info->open_time ?>">
                                    </div>
                                    <div class="col-md-2"> 
                                          <strong for="open_hours">Close Time</strong>
                                          <input class="form-control" id="kt_timepicker_1" name="close_time" readonly="" placeholder="Select time" type="text" value="<?= $location_info->close_time ?>">
                                    </div>
                                    <div class="col-md-8">
                                        <strong for="store_address">Store Address</strong>
                                        <textarea type="text" class="form-control capitalize" name="store_address" id="store_address" placeholder="Store Address" value="<?= $location_info->store_address ?>"><?= $location_info->store_address ?></textarea> 
                                    </div><br>
                        </div><br>
                        <div class="row">
                          <div class="col-md-4">
                            <strong>Current Image</strong>
                            <?php if(empty($location_info->attachment)): ?>
                            <br><span>No uploaded image</span>
                            <?php else: ?>
                           <img src="<?php echo base_url('assets/upload_files/location/'. $location_info->attachment);?>" width="100%"/>
                            <?php endif;?>
                          </div>
                            <div class="col-md-4">
                                    <strong>Image</strong>
                                    ...
                                    <div>
                                        ...
                                        <span style="float: right;">(Max: 13MB, Height:600px Width:500px)</span>
                                    </div>
                            </div>
                            <input type="hidden" name="latitude" id="latitude" placeholder="Latitude" value="<?= $location_info->latitude ?>">
                            <input type="hidden" name="longitude" id="longitude" placeholder="Longitude" value="<?= $location_info->longitude ?>">
                        </div>    
            </div>
      </div>
    </div>
