...
class Reports extends CI_Model 
{
	...
	// ======================= DATATABLE SERVER SIDE PROCESSING =========================
     ...
     var $column_order = array(null, 'id', 'name', 'email', 'contact_no', 'address', 'state', 'zipcode', 'country', 'year', 'firsttime', 'last_login', null); // field yang ada di table
    var $column_search = array('id, state, country'); // field yang diizinkan untuk pencarian 
