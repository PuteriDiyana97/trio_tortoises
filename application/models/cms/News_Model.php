...
class News_Model extends CI_Model 
{
    ...
    var $column_order = array(null, 'title', 'description', 'attachment', 'start_date', 'expiry_date',null); // field yang ada di table
    var $column_search = array('title'); // field yang diizinkan untuk pencarian 
    ...
    private function _get_datatables_query()
    {
        ...
        if(!empty($end_date))
        {
            ...
            $db->where('DATE(expiry_date) <=',date("Y-m-d", strtotime($filter_date_end_temp)));
        }
