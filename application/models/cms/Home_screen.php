<?php
class Home_screen extends CI_Model 
{
    ...
    var $column_order = array(null, 'title', 'description', 'attachment', 'created',null); // field yang ada di table
    var $column_search = array('title', 'description'); // field yang diizinkan untuk pencarian 
    var $order = array('UPPER(title)' => 'ASC'); // default order
    ...
    private function _get_datatables_query()
    {
		...
		{
    		$db->like('description', $filter_title, 'both');
		}
